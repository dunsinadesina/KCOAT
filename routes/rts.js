...
const { createOrder, viewOrders, viewParticularOrder, updateOrder, cancelOrder, updateOrderStatus, calcOrderTotal } = require('../backend/controllers/order-controller')
// Define routes
// router.get('/', home)
...
router.get('/orders/:orderId', calcOrderTotal)
